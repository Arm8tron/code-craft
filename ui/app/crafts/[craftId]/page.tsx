...
export default function Page({ params }: { params: { craftId: string } }) {
    ...
    function saveCraft() {
        ...
        const newCraftData = { html, css, js, name: craftData?.name, createdBy: craftData?.createdBy || user?.username, craftId: params.craftId }
    ...
    function toggleCraftName() {
        ...
        if (craftNameRef.current.disabled) {
            ...
            const newCraftData = { ...craftData };
            newCraftData.name = craftNameRef.current.value;
            setCraftData(newCraftData);
        }
            ...
            <header className="border-b border-slate-500 flex flex-row justify-between px-4 py-2">
                <div className="flex flex-col space-y-2">
                    <div className='flex flex-row items-center'>
                        ...
                        />
                        <Pencil className='w-4 ml-2 cursor-pointer' onClick={toggleCraftName} />
                    </div>
